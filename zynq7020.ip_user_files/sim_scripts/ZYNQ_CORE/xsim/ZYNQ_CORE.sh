...
#
# Script generated by Vivado on Fri Nov 28 15:49:02 +1100 2025
...
#
# Usage        : ZYNQ_CORE.sh
#                ZYNQ_CORE.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ZYNQ_CORE.sh [-reset_run]
#                ZYNQ_CORE.sh [-reset_log]
#                ZYNQ_CORE.sh [-help]
#
...
export RDI_DATADIR="E:/xilinx_2025_1/2025.1/Vivado/data"
...
# script info
echo -e "ZYNQ_CORE.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ZYNQ_CORE.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L xlconstant_v1_1_10 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L gmii_to_rgmii_v4_1_19 -L util_vector_logic_v2_0_5 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ZYNQ_CORE xil_defaultlib.ZYNQ_CORE xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ZYNQ_CORE -key {Behavioral:sim_1:Functional:ZYNQ_CORE} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_6a5f.protoinst" -protoinst "protoinst_files/ZYNQ_CORE.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/xilinx_2025_1/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ZYNQ_CORE.wdb xsim.dir libdpi.so)
...
Usage: ZYNQ_CORE.sh [-step]\n\
Usage: ZYNQ_CORE.sh [-lib_map_path]\n\
Usage: ZYNQ_CORE.sh [-reset_run]\n\
Usage: ZYNQ_CORE.sh [-reset_log]\n\
Usage: ZYNQ_CORE.sh [-keep_index]\n\
